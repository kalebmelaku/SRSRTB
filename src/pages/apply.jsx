...
const JobApplicationForm = () => {
  ...
  return (
    <>
      <NavBar />
      <div className="sm-container job-list custom-container mx-auto p-4">
        <div className=" my-5">
        ...
        <form onSubmit={handleSubmit}>
          <div className="flex flex-col sm:flex-row items-center justify-between mb-3 gap-4">
            <div className="md:mb-5 sm:mb-0 w-full">
              <label htmlFor="fname" className="block mb-2 text-md font-medium text-gray-900">First Name</label>
            ...
            <div className="md:mb-5 sm:mb-0 w-full">
              <label htmlFor="lname" className="block mb-2 text-md font-medium text-gray-900">Last Name</label>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            <div className=" w-full">
              <label htmlFor="phone" className="block mb-2 text-md font-medium text-gray-900">Phone Number</label>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            <div className="my-6 w-full">
              <label htmlFor="cv" className="block mb-2 text-md font-medium text-gray-900">Resume / CV</label>
